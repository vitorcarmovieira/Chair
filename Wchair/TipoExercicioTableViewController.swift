...
//        self.populate()
        ...
        if let fetchResults = managedObjectContext!.executeFetchRequest(fetchRequest1, error: nil) as? [Exercicio] {
            ...
            var ombro: GCSimpleSectionController = GCSimpleSectionController(array: self.exercicios, viewController: self)
            ombro.titulo = "Ombro"
        ...
        if let fetchResults = managedObjectContext!.executeFetchRequest(fetchRequest2, error: nil) as? [Exercicio] {
            ...
            var costa: GCSimpleSectionController = GCSimpleSectionController(array: self.exercicios, viewController: self)
            costa.titulo = "Costa"
        ...
        if let fetchResults = managedObjectContext!.executeFetchRequest(fetchRequest3, error: nil) as? [Exercicio] {
            ...
            var bi: GCSimpleSectionController = GCSimpleSectionController(array: self.exercicios, viewController: self)
            bi.titulo = "Biceps"
        ...
        if let fetchResults = managedObjectContext!.executeFetchRequest(fetchRequest4, error: nil) as? [Exercicio] {
            ...
            var tri: GCSimpleSectionController = GCSimpleSectionController(array: self.exercicios, viewController: self)
            tri.titulo = "Triceps"
